...
const products = [
  { name: "Premium Yam Tubers", price: "₦12,500", farm: "Benue State • Danladi Farms", avail: "Available: 45 Large Tubers", escrow: true, bg: "from-stone-200 to-stone-300", icon: "ri-plant-line text-stone-600" },
  { name: "Hybrid Yellow Maize", price: "₦45,000", farm: "Kaduna • Northern Grains Ltd", avail: "Available: 50kg per Bag", escrow: false, bg: "from-yellow-100 to-yellow-200", icon: "ri-seedling-line text-yellow-600" },
  { name: "Organic Vine Tomatoes", price: "₦8,200", farm: "Jos • Plateau Greens", avail: "Available: 20kg Basket", escrow: false, bg: "from-red-100 to-red-200", icon: "ri-leaf-line text-red-500" },
  { name: "Fresh Export Ginger", price: "₦22,000", farm: "Kaduna • Root Export Hub", avail: "Available: 15kg Crate", escrow: false, bg: "from-amber-100 to-amber-200", icon: "ri-plant-line text-amber-600" },
];
    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="flex gap-3">
        ...
        <button className="flex items-center gap-2 px-5 py-3 rounded-xl border border-gray-200 bg-white text-sm text-gray-600 hover:bg-gray-50 transition-colors">
          <i className="ri-equalizer-line" /> Advanced Filters
