...
async function createVerifiedUser(role, email) {
...
async function createFarmer(email) {
...
describe("GET /api/v1/marketplace/listings", () => {
    ...
    it("filters by category", async () => {
        ...
        expect(res.status).toBe(200);
        expect(res.body.data.every((l) => l.category === "grains")).toBe(true);
    });
...
describe("DELETE /api/v1/marketplace/listings/:id", () => {
    ...
    it("deletes own listing (204)", async () => {
        ...
        const listingId = create.body.listing_id;
